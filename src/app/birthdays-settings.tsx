...
export default function BirthdaysSettingsScreen() {
  ...
  const renderRadioSection = (
    ...
    return (
      <View style={styles.sectionContainer}>
        ...
        <Text style={[styles.sectionExtraDesc, { color: descColor }]}>{extraDesc}</Text>
      ...
      >
        <Animated.View entering={FadeInDown.duration(300)}>
          {renderRadioSection(
            ...
            birthdays,
            setBirthdays,
            'johnappleseed has a birthday today!',
            "We'll only notify you for people who choose to tell others about their birthdays on Instagram. You can change who to tell about your birthday any time in your profile Personal information settings."
          )}
