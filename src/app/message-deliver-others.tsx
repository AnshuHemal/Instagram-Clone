...
// MAIN SCREEN
// ─────────────────────────────────────────────
export default function MessageDeliverOthersScreen() {
  ...
  const handleSelectOption = (opt: 'requests' | 'none') => {
    setOption(opt);
    const msg = opt === 'requests'
      ? 'Requests will be delivered to Message Requests'
      : 'Requests from others disabled';
        ...
        <Animated.View entering={FadeInDown.delay(100).duration(300)}>
          ...
          <View style={styles.card}>
            <RadioRow
              ...
              selected={option === 'requests'}
              onPress={() => handleSelectOption('requests')}
              isDark={isDark}
            />
            <RadioRow
              label="Don't receive requests"
          ...
          <Text style={[styles.descText, { color: descColor }]}>
            Message requests from other accounts on Instagram will be delivered to your Message requests folder unless you choose not to receive them.
          </Text>
        </Animated.View>
      </View>
    </View>
