...
export default function RemovedContentStatusScreen() {
  ...
  const handleOpenInfo = () => {
    haptics.light();
    showToast({ message: 'Account status is healthy.', type: 'info' });
  };
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 6, borderBottomColor: isDark ? '#262626' : '#DBDBDB' }]}>
        ...
        <Pressable onPress={handleOpenInfo} hitSlop={12} style={styles.headerInfoBtn}>
          <Ionicons name="information-circle-outline" size={26} color={isDark ? '#FFFFFF' : '#000000'} />
        </Pressable>
      </View>
      ...
      <View style={styles.content}>
        ...
        >
          ...
          <Text style={[styles.sectionBody, { color: isDark ? '#A8A8A8' : '#737373', marginBottom: 12 }]}>
