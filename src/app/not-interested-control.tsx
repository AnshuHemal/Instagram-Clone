...
const mockPosts: PostItem[] = [
  { id: '1', uri: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=400', isReel: true },
  { id: '2', uri: 'https://images.unsplash.com/photo-1513836279014-a89f7a76ae86?w=400', isReel: false },
  { id: '3', uri: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400', isReel: true },
];

const screenWidth = Dimensions.get('window').width;
const imageSize = (screenWidth - 4) / 3;

export default function NotInterestedControlScreen() {
  ...
  const handleRemoveSelected = () => {
    ...
    showToast({ message: 'Removed posts from not interested list', type: 'success' });
  };
        ...
        ListHeaderComponent={
          <View style={styles.infoBlock}>
            <Text style={[styles.infoDesc, { color: descColor }]}>
              These are posts you said you weren't interested in. When you remove a post from this list, you may see more suggested posts like it on Instagram.
            </Text>
          </View>
        }
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={[styles.emptyDesc, { color: descColor }]}>
              Posts you mark as "Not interested" will appear here.
            </Text>
          </View>
        }
      />
